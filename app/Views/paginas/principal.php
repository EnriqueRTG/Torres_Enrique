...
<div class="card container user-select-none mt-5 pt-5 mt-md-0 pt-md-0 mt-lg-0 pt-lg-0" id="card-principal">
    ...
    <div class="card-body">
        ...
        <p class="card-text card-texto">Somos una empresa joven dedicada a la comercialización de máquinas, pigmentos, insumos y todo aquello
            ...
            Trabajamos ofreciendo los mejores productos, nacionales como importados, tales como: Cheyenne, Dynamic Ink, EZ, etc.</p>
    </div>
</div>
    ...
    <div class="row mt-lg-4 mt-0">
        <div class="col col-lg-4 col-md-6 col-12 mb-lg-4 mb-md-3 mb-1">
            <div class="card card-principal-per">
                <img src="<?php echo base_url(); ?>assets/images/cards-principal/maquinas.png" alt="Maquina de Tatuar" class="card-img-top">
                <div class="card-body">
        ...
        <div class="col col-lg-4 col-md-6 col-12 mb-lg-4 mb-md-3 mb-1">
            <div class="card card-principal-per">
                <img src="<?php echo base_url(); ?>assets/images/cards-principal/fuentes.png" alt="Fuente de poder" class="card-img-top">
                <div class="card-body">
        ...
        <div class="col col-lg-4 col-md-6 col-12 mb-lg-4 mb-md-3 mb-1">
            <div class="card card-principal-per">
                <img src="<?php echo base_url(); ?>assets/images/cards-principal/pigmentos.png" alt="Tintas para tatuar" class="card-img-top">
                <div class="card-body">
        ...
        <div class="col col-lg-4 col-md-6 col-12 mb-lg-4 mb-md-3 mb-1">
            <div class="card card-principal-per">
                <img src="<?php echo base_url(); ?>assets/images/cards-principal/mobiliarios.png" alt="Camilla" class="card-img-top">
                <div class="card-body">
        ...
        <div class="col col-lg-4 col-md-6 col-12 mb-lg-4 mb-md-3 mb-1">
            <div class="card card-principal-per">
                <img src="<?php echo base_url(); ?>assets/images/cards-principal/insumos.png" alt="Insumos y accesorios" class="card-img-top">
                <div class="card-body">
        ...
        <div class="col col-lg-4 col-md-6 col-12 mb-lg-4 mb-md-3 mb-1">
            <div class="card card-principal-per">
                <img src="<?php echo base_url(); ?>assets/images/cards-principal/kits.png" alt="Kit" class="card-img-top">
                <div class="card-body">
